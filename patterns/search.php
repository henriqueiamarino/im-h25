...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:60%"><!-- wp:query-title {"type":"search","align":"wide"} /-->

<!-- wp:spacer {"height":"var:preset|spacing|40","metadata":{"name":"L"},"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
...
<div style="margin-top:0;margin-bottom:0;height:2.5vh" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->

<!-- wp:template-part {"slug":"sidebar-topics"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></main>
<!-- /wp:group -->
