 ...
 * Slug: h25/sidebar-author
 * Inserter: no
 */
?>
<!-- wp:group {"metadata":{"name":"About"},"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div id="Author" class="wp-block-group"><!-- wp:heading {"metadata":{"name":"Caput"},"className":"no-underline","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.03rem"}},"fontSize":"x-small"} -->
<h2 class="wp-block-heading no-underline has-x-small-font-size" style="letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Meet Henrique', 'h25');?></h2>
<!-- /wp:heading -->
...
echo sprintf( esc_html__( 'Born in a small Brazilian town shaped by diverse cultures, %1$sHenri%2$s carries a heritage that blends Native roots with European influences. His passion for art and design started early and has only grown… %3$sMore%4$s.', 'h25' ), '<strong>', '</strong>', '<a href="' . esc_url( 'https://iamarino.com/info/' ) . '" data-type="page" data-id="3813">', '</a>' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"metadata":{"name":"Categories"},"style":{"spacing":{"blockGap":"0","margin":{"top":"var:preset|spacing|20"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--20)"><!-- wp:group {"metadata":{"name":"Category"},"style":{"spacing":{"blockGap":"var:preset|spacing|20","padding":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
...
echo sprintf( esc_html__( '%1$sWordPress Themes%2$s', 'h25' ), '<a href="' . esc_url( 'https://iamarino.com/work/' ) . '" data-type="page" data-id="3812">', '</a>' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"className":"no-underline"} -->
<p class="no-underline"><?php /* Translators: 1. is the start of a 'a' HTML element, 2. is the end of a 'a' HTML element */ 
echo sprintf( esc_html__( '%1$sNow%2$s', 'h25' ), '<a href="' . esc_url( 'https://iamarino.com/now/' ) . '">', '</a>' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
